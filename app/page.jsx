...
function HomePage() {
    return (<div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center text-xs md:text-sm font-medium">
            <div className="flex items-center space-x-4 md:space-x-8">
              <div className="flex items-center space-x-2">
                <lucide_react_1.Phone className="h-3 w-3 md:h-4 md:w-4"/>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            <div className="flex items-center space-x-3 md:space-x-4">
              <div className="flex items-center space-x-2 md:space-x-3">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-600 rounded-xl md:rounded-2xl flex items-center justify-center">
                  <lucide_react_1.Building2 className="h-5 w-5 md:h-7 md:w-7 text-white"/>
                </div>
                <div>
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              {["Personal", "Corporate", "NRI", "Digital", "About Us"].map((item) => (<button key={item} className="text-gray-700 hover:text-blue-600 font-medium transition-colors relative group">
                  {item}
            ...
            <div className="flex items-center space-x-2 md:space-x-3">
              ...
              <button_1.Button variant="outline" size="sm" className="border-blue-600 text-blue-600 hover:bg-blue-50 rounded-lg md:rounded-xl text-xs md:text-sm px-3 md:px-4">
                  Sign Up
              </button_1.Button>
              </link_1.default>
              <link_1.default href="/login">
                <button_1.Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg md:rounded-xl shadow-lg text-xs md:text-sm px-3 md:px-4">
                  Net Banking
                </button_1.Button>
              </link_1.default>
              <button_1.Button variant="ghost" size="sm" className="lg:hidden p-2">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="space-y-6 md:space-y-8 text-center lg:text-left">
              <div className="inline-flex items-center bg-blue-100 rounded-full px-4 md:px-6 py-2 md:py-3 border border-blue-200">
                <lucide_react_1.Star className="h-4 w-4 md:h-5 md:w-5 text-blue-600 mr-2"/>
              ...
              <div className="space-y-3 md:space-y-4">
                {["Advanced Fraud Detection", "Real-time Transaction Monitoring", "24/7 Secure Banking"].map((feature, index) => (<div key={index} className="flex items-center justify-center lg:justify-start space-x-3">
                      <lucide_react_1.CheckCircle className="h-4 w-4 md:h-5 md:w-5 text-green-500 flex-shrink-0"/>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                <link_1.default href="/login">
                  <button_1.Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-6 md:px-8 py-3 md:py-4 text-base md:text-lg shadow-lg w-full sm:w-auto">
                    Access Net Banking
                  </button_1.Button>
                </link_1.default>
                <link_1.default href="/signup">
                  <button_1.Button size="lg" variant="outline" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 rounded-xl px-6 md:px-8 py-3 md:py-4 text-base md:text-lg w-full sm:w-auto">
                    Create Account
                  </button_1.Button>
                </link_1.default>
                <button_1.Button size="lg" variant="outline" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 rounded-xl px-6 md:px-8 py-3 md:py-4 text-base md:text-lg w-full sm:w-auto">
                  <lucide_react_1.Download className="h-4 w-4 md:h-5 md:w-5 mr-2"/>
                  Download App
                </button_1.Button>
              </div>
            </div>
                    ...
                    <div className="absolute bottom-0 w-full flex justify-center items-end space-x-1 md:space-x-2">
                      ...
                      <div className="bg-blue-600 w-16 md:w-20 h-24 md:h-32 rounded-t-lg relative">
                        <div className="absolute top-1 md:top-2 left-1 md:left-2 right-1 md:right-2 space-y-1">
                          {[...Array(4)].map((_, i) => (<div key={i} className="flex space-x-1">
                      ...
                      <div className="bg-blue-500 w-8 md:w-12 h-16 md:h-24 rounded-t-lg">
                        <div className="mt-1 md:mt-2 mx-1 space-y-1">
                          {[...Array(3)].map((_, i) => (<div key={i} className="w-1.5 h-1.5 md:w-2 md:h-2 bg-yellow-200 rounded-sm mx-auto"></div>))}
                        </div>
                      </div>
                      <div className="bg-blue-700 w-12 md:w-16 h-20 md:h-28 rounded-t-lg">
                        <div className="mt-1 md:mt-2 mx-1 space-y-1">
                          {[...Array(4)].map((_, i) => (<div key={i} className="flex space-x-1 justify-center">
                ...
                <div className="absolute -top-4 -left-4 bg-white rounded-2xl p-3 md:p-4 shadow-lg border border-gray-100">
                  <div className="flex items-center space-x-2 md:space-x-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-green-100 rounded-xl flex items-center justify-center">
                      <lucide_react_1.Shield className="h-4 w-4 md:h-5 md:w-5 text-green-600"/>
                    </div>
                    <div>
                ...
                <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl p-3 md:p-4 shadow-lg border border-gray-100">
                  <div className="flex items-center space-x-2 md:space-x-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-yellow-100 rounded-xl flex items-center justify-center">
                      <lucide_react_1.TrendingUp className="h-4 w-4 md:h-5 md:w-5 text-yellow-600"/>
                    </div>
                    <div>
                ...
                <div className="absolute top-1/2 -right-8 bg-white rounded-2xl p-3 md:p-4 shadow-lg border border-gray-100">
                  <div className="flex items-center space-x-2 md:space-x-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-blue-100 rounded-xl flex items-center justify-center">
                      <lucide_react_1.Lock className="h-4 w-4 md:h-5 md:w-5 text-blue-600"/>
                    </div>
                    <div>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
            { icon: lucide_react_1.CreditCard, label: "Fund Transfer", href: "/login", color: "blue" },
            { icon: lucide_react_1.FileText, label: "Account Statement", color: "green" },
            { icon: lucide_react_1.Calculator, label: "EMI Calculator", color: "yellow" },
            { icon: lucide_react_1.MapPin, label: "Branch Locator", color: "purple" },
        ].map((service, index) => (<link_1.default key={index} href={service.href || "#"} className="group p-4 md:p-6 bg-white rounded-xl md:rounded-2xl border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all">
                <div className={`w-10 h-10 md:w-12 md:h-12 mb-3 md:mb-4 rounded-lg md:rounded-xl flex items-center justify-center mx-auto md:mx-0 ${service.color === "blue"
                ...
                : service.color === "green"
                    ...
                    : service.color === "yellow"
                        ...
                        : "bg-purple-100 group-hover:bg-purple-600"} transition-colors`}>
                  <service.icon className={`h-5 w-5 md:h-6 md:w-6 ${service.color === "blue"
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
            { icon: lucide_react_1.Users, value: "10M+", label: "Happy Customers", color: "blue" },
            { icon: lucide_react_1.Award, value: "115+", label: "Years of Trust", color: "yellow" },
            { icon: lucide_react_1.Zap, value: "99.9%", label: "Uptime", color: "blue" },
            { icon: lucide_react_1.Shield, value: "24/7", label: "Security", color: "yellow" },
        ].map((stat, index) => (<div key={index} className="text-center group">
                <div className={`w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-xl md:rounded-2xl flex items-center justify-center ${stat.color === "blue" ? "bg-blue-100" : "bg-yellow-100"} group-hover:scale-110 transition-transform`}>
                  <stat.icon className={`h-6 w-6 md:h-8 md:w-8 ${stat.color === "blue" ? "text-blue-600" : "text-yellow-600"}`}/>
                </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        ...
        ].map((service, index) => (<card_1.Card key={index} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg hover:-translate-y-2">
                <card_1.CardContent className="p-6 md:p-8 text-center">
                  <div className={`w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 md:mb-6 rounded-xl md:rounded-2xl flex items-center justify-center ${service.color === "blue"
                ? "bg-blue-100 group-hover:bg-blue-600"
                : "bg-yellow-100 group-hover:bg-yellow-400"} transition-colors`}>
                    <service.icon className={`h-6 w-6 md:h-8 md:w-8 ${service.color === "blue"
                ? "text-blue-600 group-hover:text-white"
                : "text-yellow-600 group-hover:text-white"} transition-colors`}/>
                  </div>
                  ...
                  <button_1.Button variant="link" className={`${service.color === "blue" ? "text-blue-600" : "text-yellow-600"} p-0 font-semibold group-hover:underline text-sm md:text-base`}>
                    Learn More <lucide_react_1.ChevronRight className="h-3 w-3 md:h-4 md:w-4 ml-1"/>
                  </button_1.Button>
                </card_1.CardContent>
              </card_1.Card>))}
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-blue-50 to-yellow-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="space-y-6 md:space-y-8 text-center lg:text-left">
              ...
              <div className="space-y-3 md:space-y-4">
                {[
            { icon: lucide_react_1.Shield, label: "Advanced Security Features", color: "blue" },
            { icon: lucide_react_1.Smartphone, label: "Mobile Banking App", color: "yellow" },
            { icon: lucide_react_1.Globe, label: "Internet Banking", color: "blue" },
            { icon: lucide_react_1.CreditCard, label: "UPI & Digital Payments", color: "yellow" },
        ].map((feature, index) => (<div key={index} className="flex items-center space-x-3 md:space-x-4 p-3 md:p-4 bg-white rounded-xl md:rounded-2xl shadow-sm hover:shadow-md transition-shadow justify-center lg:justify-start">
                    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl flex items-center justify-center ${feature.color === "blue" ? "bg-blue-100" : "bg-yellow-100"}`}>
                      <feature.icon className={`h-5 w-5 md:h-6 md:w-6 ${feature.color === "blue" ? "text-blue-600" : "text-yellow-600"}`}/>
                    </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                ...
                <button_1.Button variant="outline" className="border-2 border-yellow-500 text-yellow-600 hover:bg-yellow-50 rounded-xl px-6 md:px-8 py-3 text-base md:text-lg w-full sm:w-auto">
                  <lucide_react_1.Download className="h-4 w-4 md:h-5 md:w-5 mr-2"/>
                  Download App
                </button_1.Button>
              </div>
        ...
        ].map((stat, index) => (<div key={index} className={`p-4 md:p-6 rounded-xl md:rounded-2xl text-center ${stat.color === "blue" ? "bg-blue-50" : "bg-yellow-50"}`}>
                      <div className={`text-2xl md:text-3xl font-bold mb-1 md:mb-2 ${stat.color === "blue" ? "text-blue-600" : "text-yellow-600"}`}>
                        {stat.value}
                      </div>
      ...
      <footer className="bg-gray-900 text-white py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 md:mb-12">
            <div className="space-y-4 md:space-y-6 text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start space-x-2 text-gray-300">
                <lucide_react_1.Phone className="h-4 w-4 md:h-5 md:w-5 text-yellow-400"/>
        ...
        ].map((section, index) => (<div key={index} className="text-center md:text-left">
          ...
          <div className="border-t border-gray-800 pt-6 md:pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-4 md:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6">
                {["Privacy Policy", "Terms & Conditions", "Disclaimer"].map((link) => (<a key={link} href="#" className="text-gray-400 hover:text-yellow-400 transition-colors text-sm">
                    {link}
                  </a>))}
              </div>
            </div>
